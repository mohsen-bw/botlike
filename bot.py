...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"سلام ﷽؏لے؁شـʝ۝KΞℜ؁جۏڪ؁ࢪمﷺ هستم ربات کنسلی و لایک خودکار",
    "lang":"JP",
    "comment":"سلام ﷽؏لے؁شـʝ۝KΞℜ؁جۏڪ؁ࢪمﷺ هستم ربات کنسلی و لایک خودکار",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					...
					try: 
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ربات خودکار @﷽؏لے؁شـʝ۝KΞℜ؁جۏڪ؁ࢪمﷺ")
