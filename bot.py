...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Auto Like By mohsem-bw",
    "lang":"JP",
    "comment":"Auto Like By mohsem-bw
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					...
					try: 
						...
						CL . نظر ( hasil [ «نتیجه» ] [ "پست ها" ] [ ZX ] [ . userInfo، ] [ ، اواسط ' ]، hasil [ «نتیجه» ] [ "پست ها" ] [ ZX ] [ . postInfo، ] [ ، انجمن وجود نداشته باشد. ]، "به صورت خودکار با mohsem-bw line.me/ti/p/~Masih.0." )
the
